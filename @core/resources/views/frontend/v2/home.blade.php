                ...
                <div class="col-sm-6 col-xs-9 about-content">
                    <div>
                        <label class="about-title">
                            {{filter_static_option_value('construction_about_section_vi_title',$static_field_data)}}
                        </label>
                    </div>
                    <div class="about-desc">
                        {!! filter_static_option_value('construction_about_section_vi_description',$static_field_data) !!}
                    </div>
                </div>
            </div>
        </section>
